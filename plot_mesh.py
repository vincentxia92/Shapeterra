...
def plot_mesh(coord_array, tri_array,figure_name = 'Mesh'):
    ...
    mlab.figure(figure = figure_name, bgcolor = (1,1,1), fgcolor = (0,0,0),size=(1500, 1250))
...
if __name__ == '__main__':
    ...
    data =  np.load('/Users/User/OneDrive - University of South Carolina/New/Feature_Net/face_interaction/models/pocket.step.npz')
